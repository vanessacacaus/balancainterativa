...
function ladoBalanca() {
    if(somaEsq<somaDir){
       /* document.getElementById('div1').style.marginTop = "15px"
        ...
        /* document.getElementById('div1').style.marginTop = "-70px"
        document.getElementById('div2').style.marginTop = "15px"
...
function passaFase(){
    if(acertos == 8){
        //savaTexto();
        document.getElementById("txtFeedback").innerHTML = "Parabéns!</br>Você terminou o nível 10 com</br>"+mov+" movimentos.</br>Deseja avançar de nível?";
...
function savaTexto(){
    ...
    var secFinal = data.getSeconds();
        ...
        saveAs(blob, "Resultados fase 10");
