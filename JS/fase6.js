...
function passaFase(){
    if(acertos == 8){
        //savaTexto();
        document.getElementById("txtFeedback").innerHTML = "Parabéns!</br>Você terminou o nível 6 com</br>"+mov+" movimentos.</br>Deseja avançar de nível?";
